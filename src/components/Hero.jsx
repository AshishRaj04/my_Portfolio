    ...
    <section className="relative w-full h-screen mx-auto">
      <div className="sm:px-16 px-6 absolute inset-0 top-20 max-w-7xl mx-auto flex flex-col justify-start items-center gap-5">
        <div className="flex flex-col justify-center items-center mt-5">
          <div>
            <h1 className="font-black text-primary lg:text-[80px] sm:text-[60px] xs:text-[50px] text-[40px] lg:leading-[98px] mt-2">
              Hi , I'm
            </h1>
            <div className="flex gap-5">
              <div className="hidden sm:flex w-[9rem]">
                <span className="inline-block  text-[3rem] font-semibold  lg:text-[4rem] lg:font-bold text-primary">
                  {"{"}
                </span>
                <img
                  src={reactjs}
